...
class BookSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $book1 = Book::firstOrCreate([
            ...
            'image_url' => 'https://placehold.jp/3d4070/ffffff/300x300.png?text=1',
            'description' => '',
        ...
        $book2 = Book::firstOrCreate([
            ...
            'image_url' => 'https://placehold.jp/3d4070/ffffff/300x300.png?text=2',
        ...
        $book3 = Book::firstOrCreate([
            ...
            'image_url' => 'https://placehold.jp/3d4070/ffffff/300x300.png?text=3',
        ...
        $book4 = Book::firstOrCreate([
            ...
            'image_url' => 'https://placehold.jp/3d4070/ffffff/300x300.png?text=4',
        ...
        $book5 = Book::firstOrCreate([
            ...
            'image_url' => 'https://placehold.jp/3d4070/ffffff/300x300.png?text=5',
            'description' => '',
            'user_id' => $users->random()->id,
        ...
        $book6 = Book::firstOrCreate([
            ...
            'image_url' => 'https://placehold.jp/3d4070/ffffff/300x300.png?text=6',
            'description' => '',
            'user_id' => $users->random()->id,
        ...
        $book7 = Book::firstOrCreate([
            ...
            'image_url' => 'https://placehold.jp/3d4070/ffffff/300x300.png?text=7',
        ...
        $book8 = Book::firstOrCreate([
            ...
            'image_url' => 'https://placehold.jp/3d4070/ffffff/300x300.png?text=8',
            'description' => '『嫌われる勇気』は、他人の評価に縛られず、自分の人生を主体的に生きるための考え方を対話形式で学ぶ本です。',
            'user_id' => $users->random()->id,
            'created_at' => Carbon::today()->subDays(8),
        ]);
        $book8->genres()->sync([4]);
        ...
        $book9 = Book::firstOrCreate([
            ...
            'image_url' => 'https://placehold.jp/3d4070/ffffff/300x300.png?text=9',
        ...
        $book10 = Book::firstOrCreate([
            ...
            'image_url' => 'https://placehold.jp/3d4070/ffffff/300x300.png?text=10',
        ...
        $book11 = Book::firstOrCreate([
            ...
            'image_url' => 'https://placehold.jp/3d4070/ffffff/300x300.png?text=11',
            'description' => '',
            'user_id' => $users->random()->id,
            'created_at' => Carbon::today()->subDays(11),
        ]);
